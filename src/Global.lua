...
gen5PokemonData =
{
  ...
  { name = "Dewott",          level = 3, types = { "Water" },    moves = { "Fury Cutter", "Aqua Jet" },        guids = { "89e6b6", "1eef77" },           evoData = { { cost = 2, ball = RED, gen = 5, guids = { "ba028a", "d8975e" } }, { cost = 2, ball = RED, gen = 8, guids = { "769c18", "c7dc10" } } } },
  { name = "Samurott",        level = 5, types = { "Water" },    moves = { "Razor Shell", "Aerial Ace" },      guids = { "49d4d0", "ba028a", "d8975e" } },
  ...
  { name = "Darumaka",        level = 3, types = { "Fire" },     moves = { "Fire Fang", "Rollout" },           guids = { "fd08bc" },                     evoData = { { cost = 2, ball = YELLOW, gen = 5, guids = { "166758" } }, { cost = 2, ball = YELLOW, gen = 5, guids = { "f7de99" } } } },
  { name = "Darmanitan",      level = 5, types = { "Fire" },     moves = { "Fire Punch", "Superpower" },       guids = { "1c3955", "166758" } },  -- Red
  { name = "Darmanitan",      level = 5, types = { "Fire" },     moves = { "Zen Headbutt", "Fire Punch" },     guids = { "7c085e", "f7de99"  } }, -- Blue
